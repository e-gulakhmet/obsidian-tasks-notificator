...
def test_send_notification_includes_message_thread_id_when_topic_set(respx_mock):
    ...
    send_notification("TOKEN", "CHAT", _reminder(reminder_type="relative", offset="-PT0M"), _task(), topic_id="42")
...
def test_send_notification_no_message_thread_id_when_topic_not_set(respx_mock):
    ...
    send_notification("TOKEN", "CHAT", _reminder(reminder_type="relative", offset="-PT0M"), _task(), topic_id=None)
    payload = json.loads(respx_mock.calls[0].request.content)
